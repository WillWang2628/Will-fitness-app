...
const LOCAL_WORKOUT_ROWS = [
  { day: 1, dayName: "胸", order: 0, slot: "warmup", name: "跑步機或飛輪暖身", target: "心肺/熱身", sets: "1", reps: "10分鐘", rest: 0, video: "https://www.youtube.com/watch?v=_mez_sRxME0", notes: "強度中等，不要練到喘不過氣" },
  ...
  { day: 2, dayName: "背", order: 0, slot: "warmup", name: "跑步機或飛輪暖身", target: "心肺/熱身", sets: "1", reps: "10分鐘", rest: 0, video: "https://www.youtube.com/watch?v=_mez_sRxME0", notes: "不要用划船機暖身，會先操到背" },
  ...
  { day: 3, dayName: "肩", order: 0, slot: "warmup", name: "跑步機或飛輪暖身", target: "心肺/熱身", sets: "1", reps: "10分鐘", rest: 0, video: "https://www.youtube.com/watch?v=_mez_sRxME0", notes: "" },
  ...
  { day: 4, dayName: "手臂", order: 0, slot: "warmup", name: "跑步機或飛輪暖身", target: "心肺/熱身", sets: "1", reps: "10分鐘", rest: 0, video: "https://www.youtube.com/watch?v=_mez_sRxME0", notes: "" },
  ...
  { day: 5, dayName: "弱點日", order: 0, slot: "warmup", name: "跑步機或飛輪暖身", target: "心肺/熱身", sets: "1", reps: "10分鐘", rest: 0, video: "https://www.youtube.com/watch?v=_mez_sRxME0", notes: "" },
